class FormbasicsController < ApplicationController
	...
	def form_tag
		@title1 = "Form Tag Details"
		@course1 = { :id => 1, :name => "First Junior High" }
		@course = ["First Junior High", "Second Junior High", "Third Junior High",
				   "First Senior High", "Second Senior High", "Third Senior High"]
		render partial: "form_tag"
	end
